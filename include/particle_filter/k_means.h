...
public:
    ...
    inline std::vector<Eigen::VectorXd> means() const {
        return means_;
    }
    inline std::vector<Eigen::MatrixXd> covariances() const {
        return covariances_;
    }
    inline std::vector<int> assignments() const {
        return assignments_;
    }
    inline std::vector<int> clusterCardinalities() const {
        return cluster_cardinalities_;
    }
