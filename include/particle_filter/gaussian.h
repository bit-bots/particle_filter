...
public:
    ...
    inline Eigen::VectorXd mean() const {
        return mean_;
    }
    void setCovariance(const Eigen::MatrixXd& covariance);
    inline Eigen::MatrixXd covariance() const {
        return covariance_;
    }
    void setMeanCovariance(const Eigen::VectorXd& mean,
            const Eigen::MatrixXd& covariance);
    std::string toString() const;
    void addToEigenMatrix(Eigen::MatrixXd& matrix,
            float x0,
            float y0,
            float x1,
            float y1,
